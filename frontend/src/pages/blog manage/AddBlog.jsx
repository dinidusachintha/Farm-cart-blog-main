...
function AddNews() {
  ...
  function addNews(e) {
    ...
    axios.post("http://localhost:8000/news/add", formData)
      .then(() => {
  ...
  return (
    <>
      {successMessage && (
        <div className="mb-4 p-4 text-white bg-blue-600 rounded-md text-center">
          {successMessage}
        </div>
      )}
      <section className="max-w-4xl p-6 mx-auto bg-blue-700 rounded-md shadow-md dark:bg-gray-800 mt-20">
        ...
        <form onSubmit={addNews}>
          <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label className="block mb-2 text-l font-medium text-white dark:text-white" htmlFor="newsImage">Upload Image</label>
              <input
                name="newsImage"
            ...
            {imagePreview && (
              <div className="col-span-2 mt-4">
                ...
                <img src={imagePreview} alt="Preview" className="mt-2 rounded-md w-full h-auto" />
              </div>
            )}
          </div>
